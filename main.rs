...
// Blockchain is a vector of blocks
pub struct App {
    pub blocks: Vec,
}
...
impl App {
    ...
    // does not implement consensus algo so distrib issue if 
    // 2 nodes mine and send a block at same time
    ...
    // Always choose longest valid chain from a node
